            ...
            <div className="cardBlur p-5 mb-5">
              ...
              <Fade left>
                ...
                <small>
                  ...
                  dimension. Respect is a fundamental part of a sport, for sport
                  generates situations of tension that have to be resolved
                  almost instantaneously. There is, therefore, a need, above
                  rules and standards, for this value to be present in order to
              ...
              <Fade left>
                ...
                <small>
                  ...
                  instead luck, opportunism, and immediate triumph. However, the
                  ...
                  is promoting a culture of effort as the vehicle for academic
                  development and personal achievement, and this helps to
              ...
              <Fade left>
                ...
                <small>
                  ...
                  both to individuals and to groups. It involves the use of a
                  web of values as varied as excellence, patience, discipline,
                  order, motivation, and responsibility. Indeed, ambition
                  invokes and requires a broad system of values and, in turn, is
                  related to a job being done well, effort and rigour. Regarding
              ...
              <Fade left>
                ...
                <small>
                  ...
                  them to achieve those very goals: effort, perseverance,
                  self-control, etc. We are all aware of how DCCA has dealt with
                  its victories of recent years, and how it has always shown
                  humility (and also such values as effort, rigour,
